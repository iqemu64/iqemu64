...
TranslationBlock *tb_gen_code(CPUState *cpu,
                              ...
                              uint32_t flags,
                              int cflags, const char *types);
void tb_find_and_gen_by_types(CPUState *cpu,
                              const char *types);
...
//
// AArch64tox64.c
void *abi_a2x_gen_trampoline_for_name(const char *symbolname, target_ulong pc);
void *abi_a2x_gen_trampoline_for_types(const char *types, target_ulong pc);
...
void cpu_xloop_helper(fnEntryTranslation entry_translation, fnExitTranslation exit_translation, target_ulong *regs);
void cpu_xloop(void);
