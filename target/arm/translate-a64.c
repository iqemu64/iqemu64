                        ...
                        unsigned int op1, unsigned int op2, unsigned int crm)
{
    ...
    case 0b00001: /* YIELD */
         ...
         */
        if (!(1/*tb_cflags(s->base.tb) & CF_PARALLEL*/)) {
                                ...
                                TCGv_i64 addr, int size, int is_pair)
{
    ...
    if (is_pair) {
        ...
        } else if (1/*tb_cflags(s->base.tb) & CF_PARALLEL*/) {
            if (!HAVE_CMPXCHG128) {
...
target_ulong aarch64_pc_first(const DisasContextBase *dcbase)
{
    DisasContext *dc = container_of(dcbase, DisasContext, base);
    return dc->base.pc_first;
}
